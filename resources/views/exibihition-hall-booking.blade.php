					...
					<div class="row d-flex align-items-center">
						<div class="col-lg-12 col-md-12 col-sm-12">
							<div class="hero-3-txt text-center white-color">
								<h2 class="oxygen-font-900 event-title" style="text-transform: uppercase;">EXHIBITION STALL BOOKING FORM</h2>
								...
								<a href="#"  style="margin: 10px;padding: 10px 20px;border-color: #F8C400;color: #233234;" class="btn btn-sm btn-rounded btn-olive tra-white-hover" >Exhibit</a>
								<a href="{{url('/advertisement-release-form')}}" style="margin: 10px;padding: 10px 20px;border-color: #F8C400;" class="btn btn-sm btn-rounded btn-tra-white primary-hover" class="">Advertise</a>
				...
				<div class="container">
					<div class="card">
						<div class="card-body">
							<div class="row">
								<div class="col-md-9">
									<form id="addPaymentForm" method="POST" action="{{url('exibihition-hall-booking')}}" class="needs-validation" >
										@csrf
										...
										<fieldset id="step1">
											<div class="form-card">
												<h2 class="package-title">Exhibition Stall Layout</h2>
												<div class="mb-3">
														...
														<div>
															<div class="row featuer-list" style="padding:16px 0px;">
																@if(count($stalls)>0)
																	...
																	<div class="col-md-6">
																		<p style="font-size: 14px;display: flex;align-items: center;"><span style="margin-right: 10px !important;background:{{$stall->color?$stall->color:'#fff'}}" class="booked_box mr-2"></span> {{$stall->name}}</p>
																	</div>
																	@endforeach
																@endif
															</div>
																		...
																		@for ($i = 1; $i <= $stalllayout->vartical_grid; $i++)
																			<div class="row_line">
																				@for ($j = 1; $j <= $stalllayout->horizontal_grid; $j++)
																					<div class="cell">
																						{{getStallGridBox($i, $j, $stallGrids, $bookedStall, $stalls)}}
																					</div>
																				@endfor
													...
													<div class="col-md-12">
														...
														<div class="row">
															...
															<div class="form-group mb-3 col-md-6 requird">
																...
																<input type="text" style="text-transform: uppercase" format="GSTIN" name="GSTIN" id="GSTIN" class="form-control" placeholder="GSTIN" required/>
															</div>
															...
															<div class="form-group mb-3 col-md-6 requird">
																...
																<input type="number" min="1" name="tel_phone" id="tel_phone" class="form-control mobile" placeholder="Tel Phone" required/>
															</div>
															<div class="form-group mb-3 col-md-6 requird">
																...
																<div class="input-group mb-3">
																	...
																	<input type="number" min="1" name="mobile_phone" id="mobile_phone" class="form-control mobile" placeholder="Mobile Phone" required/>
																</div>		
															</div>
															<div class="form-group mb-3 col-md-6 requird">
								...
								<div class="col-md-3">
									<div class="cart-section">
										<div>
											<p style="color:#44929F;font-size: 13px;"><b>Exhibition Stall</b></p>
										...
										<div id="room_cart" style="display: none">
											...
											<p class="mb-0" style="display: flex;justify-content: space-between;font-size: 13px;" id="selected_room_info"></p>
...
// 		console.log('inputs', inputs);
	...
	function CalculateRightPanel(){
		...
		if(freeDelegate == 0 && paidDelegate == 0){
			$('#delegate_cart').hide();
		}
	...
	$(document).ready(function(){
		...
		$("input.stall_input:checkbox").on('click', function() {
			...
			var $box = $(this);
			if(list.length>0){
				$($box).attr('required', false);
			}else{
				$($box).attr('required', true);
			}
			if ($box.is(":checked")) {
	...
	$('#addPaymentButton, #addButtonAction').on('click', function (e) {
		...
		if(stepVerified){
			...
			$.ajax({
				...
				type: "post",
				url: window.location.origin+'/api/v1/exibihition-hall-booking',
				data: passobject,
