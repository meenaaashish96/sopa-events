		...
		<div class="content-wrapper">
			...
			<div class="card">
				...
				<div class="card-body border-top">
					<form method="POST" action="{{url('sopa/admin/sponsors/category/edit/'.$category->id)}}" enctype="multipart/form-data" class="needs-validation" novalidate>
						@csrf
						<div class="row">
							...
							{{-- <div class="mb-3  col-md-6">
								...
								<input type="number" min="1" name="order" class="form-control"   value="{{$category->order}}" placeholder="Order No." />
							</div> --}}
