		...
		<div class="content-wrapper">
			...
			<div class="card">
				<div class="card-header">
					<h5 class="mb-0">Add Stall</h5>
				</div>

				<div class="card-body border-top">
					<form method="POST" action="{{url('sopa/admin/stall/add')}}" enctype="multipart/form-data" class="needs-validation" novalidate>
						@csrf
						...
						<div class="row">
							...
							<div class="mb-3 col-md-6">
								...
								<input type="text" name="package_type" class="form-control" placeholder="Package Type" required />
							</div>

							<div class="mb-3 col-md-6">
								<label class="form-label">Complementary Delegate<sup>*</sup></label>
								<input type="number" min="1" name="complementary_delegate" class="form-control" placeholder="Complementary Delegate" required />
							</div>

							{{-- <div class="mb-3">
								<label class="form-label">Stall<sup>*</sup></label>
								<input type="text" name="stall" class="form-control" placeholder="1, 2, 3, 4, 7" required />
							</div> --}}

							<div class="mb-3 col-md-6">
								<label class="form-label">Color<sup>*</sup></label>
								<input type="color" style="height: 40px;" name="color" class="form-control" placeholder="" required />
							</div>
