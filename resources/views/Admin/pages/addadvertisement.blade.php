		...
		<div class="content-wrapper">
			...
			<div class="card">
				...
				<div class="card-body border-top">
					<form method="POST" action="{{url('sopa/admin/advertisement/add')}}" enctype="multipart/form-data" class="needs-validation" novalidate>
						@csrf
						...
						<div class="row">
							...
							<div class="mb-3 col-md-6">
								...
								<input type="text" name="print_area" class="form-control" placeholder="Print Area" required />
							</div>
							...
							<div class="mb-3 col-md-4">
								...
								<input type="number" min="0" name="booking_limit" class="form-control" placeholder="Booking Limit" required />
							</div>
