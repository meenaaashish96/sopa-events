					...
					<div class="col-md-9">
						...
						<div class="card">
							<div class="card-header">
								<h5 class="mb-0">Hotel Room Registation</h5>
							</div>
								...
								<form method="POST" class="needs-validation" action="{{url('sopa/admin/delegates/registations/add')}}" enctype="multipart/form-data" novalidate>
									...
									<div class="row">
										...
										<div class="form-group mb-3 col-md-6">
											...
											<input type="text" name="GSTIN" id="GSTIN" pattern="([0-9]){2}([a-zA-Z]){5}([0-9]){4}([a-zA-Z]){1}([a-zA-Z0-9]){1}([a-zA-Z0-9]){1}([a-zA-Z0-9]){1}" class="form-control" placeholder="GSTIN" />
										</div>
										<div class="form-group mb-3 col-md-12">
