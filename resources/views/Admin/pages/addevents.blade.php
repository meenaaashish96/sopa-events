		...
		<div class="content-wrapper">
			...
			<div class="card">
				...
				<div class="card-body border-top">
					<form id="addPaymentForm" method="POST" action="{{url('sopa/admin/event/add')}}" enctype="multipart/form-data" class="needs-validation" novalidate>
						@csrf
						<div class="row">
							...
							<div class="mb-3  col-md-6">
								...
								<input type="datetime-local" name="start_date" class="form-control" placeholder="Your strong password"  required />
							</div>

							<div class="mb-3  col-md-6">
								<label class="form-label">End Date<sup>*</sup></label>
								<input type="datetime-local" name="end_date" class="form-control" placeholder="Your strong password" required>
							</div>
							...
							<div class="mb-3  col-md-6">
								...
								{{-- <img id="previewImgLogo" src="{{asset('images/default/upload.webp')}}"  width="100%" height="auto" alt="Placeholder" style="max-width: 120px"> --}}
							</div>
