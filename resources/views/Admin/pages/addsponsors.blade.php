		...
		<div class="content-wrapper">
			...
			<div class="card">
				...
				<div class="card-body border-top">
					<form method="POST" action="{{url('sopa/admin/sponsors/add')}}" enctype="multipart/form-data" class="needs-validation" novalidate>
						@csrf
						...
						<div class="row">
							...
							<div class="mb-3 col-md-6">
								...
								<input type="number" min="0" name="received_amount" class="form-control" placeholder="Received  Amount" required />
							</div>
							<div class="mb-3 col-md-12">
								<label class="form-label">Deliverables</label>
								<textarea class="form-control ckmessage" name="deliverables" id="ckmessage"></textarea>
							</div>
