{{-- <div class="navbar  navbar-expand-lg navbar-expand-md navbar-expand-sm navbar-light d-md-show">
            <div class="navbar-collapse collapse">
                <span class="navbar-text">
                    &copy; <?php echo date("Y"); ?> - <?php echo date("Y")+1; ?>. <a> Developed</a> by <a target="blank" href="{{url('')}}">AKshat Holkar</a>
                </span>
			...
			<div class="p-3">
				<div class="d-flex align-items-start mb-3">
					<a href="#" class="status-indicator-container me-3">
						<img src="https://demo.interface.club/limitless/demo/template/assets/images/demo/users/face1.jpg" class="w-40px h-40px rounded-pill" alt="">
					...
					<div class="flex-fill">
						...
						<div class="d-flex my-2">
							<a href="#" class="status-indicator-container me-1">
								<img src="https://demo.interface.club/limitless/demo/template/assets/images/demo/users/face10.jpg" class="w-32px h-32px rounded-pill" alt="">
								<span class="status-indicator bg-danger"></span>
							</a>
							<a href="#" class="status-indicator-container me-1">
								<img src="https://demo.interface.club/limitless/demo/template/assets/images/demo/users/face11.jpg" class="w-32px h-32px rounded-pill" alt="">
								<span class="status-indicator bg-success"></span>
							</a>
							<a href="#" class="status-indicator-container me-1">
								<img src="https://demo.interface.club/limitless/demo/template/assets/images/demo/users/face12.jpg" class="w-32px h-32px rounded-pill" alt="">
								<span class="status-indicator bg-success"></span>
							</a>
							<a href="#" class="status-indicator-container me-1">
								<img src="https://demo.interface.club/limitless/demo/template/assets/images/demo/users/face13.jpg" class="w-32px h-32px rounded-pill" alt="">
								<span class="status-indicator bg-success"></span>
							</a>
    ...
    <div class="navbar navbar-sm navbar-footer border-top">
        <div class="container-fluid">
            <span>   &copy; <?php echo date("Y"); ?> - <?php echo date("Y")+1; ?>. <a> Developed</a> by <a target="blank" href="{{url('')}}">Akshat Holkar</a></span>

            {{-- <ul class="nav">
                <li class="nav-item">
                    <a href="../../../../../../../kopyov.ticksy.com/index.html" class="navbar-nav-link navbar-nav-link-icon rounded" target="_blank">
                ...
                <li class="nav-item ms-md-1">
                    <a href="../../../../../../../themeforest.net/item/limitless-responsive-web-application-kit/130803287d6b.html?ref=kopyov" class="navbar-nav-link navbar-nav-link-icon text-primary bg-primary bg-opacity-10 fw-semibold rounded" target="_blank">
                        <div class="d-flex align-items-center mx-md-1">
