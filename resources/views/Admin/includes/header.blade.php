...
<head>
	...
	<title>SOPA | Events</title>
	<meta charset='UTF-8'>
	<meta name='title' id='meta_title' content='SOPA | Events'>
	<meta name='keywords' id='meta_keywords' content='SOPA, Soybean, Processors, Association , India'>
	<meta name='description' id='meta_description' content='SOPA | Events'>
	<meta name='url'  id='meta_url' content='{{ url('/')}}'>
	<link rel='canonical'  id='meta_canonical' href='{{ url('/')}}'>
	...
	<!-- Global stylesheets -->
	<link href="{{ url('/admin/css/inter.css')}}" rel="stylesheet" type="text/css">
	<link href="{{ url('/admin/css/styles.min.css')}}" rel="stylesheet" type="text/css">
	<link href="{{ url('/admin/css/all.min.css')}}" id="stylesheet" rel="stylesheet" type="text/css">
	<!-- /global stylesheets -->
	<style>
		/* .ph-rupee{
			font-size: 18px;
	...
	<!-- Core JS files -->
	<script src="{{ url('/admin/js/demo_configurator.js')}}"></script>
	<script src="{{ url('/admin/js/bootstrap.bundle.min.js')}}"></script>
	<!-- /core JS files -->

	<!-- Theme JS files -->
	<!-- <script src="https://demo.interface.club/limitless/demo/template/assets/js/vendor/visualization/d3/d3.min.js"></script>
	<script src="https://demo.interface.club/limitless/demo/template/assets/js/vendor/visualization/d3/d3_tooltip.js"></script> -->
	...
	<script src="{{ url('/admin/js/datepicker.min.js')}}"></script>

	<script src="{{ url('/admin/js/glightbox.min.js')}}"></script>

	
	<script src="{{ url('/admin/js/bootstrap_multiselect.js')}}"></script>
	<script src="{{ url('/admin/js/tokenfield.min.js')}}"></script>
	<script src="{{ url('/admin/js/app.js')}}"></script>
	<script src="{{ url('/admin/js/datatables_basic.js')}}"></script>
	<script src="{{ url('/admin/js/dashboard.js')}}"></script>
	<script src="{{ url('/admin/js/form_layouts.js')}}"></script>
	<script src="{{ url('/admin/js/picker_date.js')}}"></script>
	<script src="{{ url('/admin/js/gallery.js')}}"></script>
	<script src="{{ url('/admin/js/form_tags.js')}}"></script>
	<script src="{{ url('/admin/js/form_multiselect.js')}}"></script>

	<script src="{{ url('/admin/js/excelexportjs.js')}}"></script>
	...
	<div class="navbar navbar-dark navbar-expand-lg navbar-static border-bottom border-bottom-white border-opacity-10">
		<div class="container-fluid">
			...
			<div class="navbar-brand flex-1 flex-lg-0">
				<a href="{{url('/sopa/admin')}}" class="d-inline-flex align-items-center">
					<img src="{{ url('/img/logo.png')}}" alt="">
					{{-- <img src="{{ url('/img/logo.png')}}" class="d-none d-sm-inline-block h-16px ms-3" alt=""> --}}
				</a>
			</div>
						...
						<div class="dropdown-menu-scrollable pb-2">
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img src="https://demo.interface.club/limitless/demo/template/assets/images/demo/users/face10.jpg" class="w-40px h-40px rounded-pill" alt="">
							...
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img src="https://demo.interface.club/limitless/demo/template/assets/images/demo/users/face3.jpg" class="w-40px h-40px rounded-pill" alt="">
							...
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img src="https://demo.interface.club/limitless/demo/template/assets/images/demo/users/face24.jpg" class="w-40px h-40px rounded-pill" alt="">
									<span class="status-indicator bg-success"></span>
								</div>
								<div class="flex-1">
							...
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img src="https://demo.interface.club/limitless/demo/template/assets/images/demo/users/face4.jpg" class="w-40px h-40px rounded-pill" alt="">
							...
							<a href="#" class="dropdown-item align-items-start text-wrap py-2">
								<div class="status-indicator-container me-3">
									<img src="https://demo.interface.club/limitless/demo/template/assets/images/demo/users/face25.jpg" class="w-40px h-40px rounded-pill" alt="">
						...
						<div class="dropdown-menu w-100" data-color-theme="light">
							...
							<div class="dropdown-menu-scrollable-lg">
								...
								<div class="dropdown-item cursor-pointer">
									<div class="me-3">
										<img src="https://demo.interface.club/limitless/demo/template/assets/images/demo/users/face3.jpg" class="w-32px h-32px rounded-pill" alt="">
									</div>
								...
								<div class="dropdown-item cursor-pointer">
									<div class="me-3">
										<img src="https://demo.interface.club/limitless/demo/template/assets/images/demo/users/face24.jpg" class="w-32px h-32px rounded-pill" alt="">
									</div>
				...
				<li class="nav-item nav-item-dropdown-lg dropdown ms-lg-2">
					<a href="#" class="navbar-nav-link align-items-center rounded-pill p-1" data-bs-toggle="dropdown">
						<div class="status-indicator-container">
							<img  src="{{ url('/img/logo.png')}}" class="w-32px h-32px rounded-pill" alt="">
							<span class="status-indicator bg-success"></span>
						</div>
						<span class="d-none d-lg-inline-block mx-lg-2">{{session('Adminuser.name')}}</span>
					</a>
					...
					<div class="dropdown-menu dropdown-menu-end">
						...
						<a href="{{url('/sopa/admin/logout')}}" class="dropdown-item">
