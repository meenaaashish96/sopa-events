						   ...
						   <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <!--<input name="search" id="search" placeholder="Search By Mobile Nubmer" />-->
                                        ...
                                        <div>
                                            <table id="request-list" class="table" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th>Name</th>
                                                        <th>Mobile</th>
                                                ...
                                                <tbody>
                									...
                									<tr>
                										...
                										<td class="text-center">
                										    ...
                										    @if(session('Operatoruser.name') == 'operator')
                										   <a onclick="PrintBadge('{{$user->id}}', '{{$user->name}}', '{{$user->deletegateRegistation->organization_name}}')" type="button" class="btn bg-primary btn-labeled rounded-pill link-white">Badge Print</a>
                										    @else
                										   <a type="button" href="{{url('/operator-panel/registred-entries/action/'.$user->id)}}"  class="btn bg-primary btn-labeled rounded-pill link-white">Mark Assign</a>
                										    @endif
                										 <!--   @if($user->batch_assign == '0')-->
...
// 			},
			type: "get",
			url: window.location.origin+'/api/v1/badge-print/'+id,
			success: function (data) {
				...
				// return false;
				// /operator-panel/registration-assigned'
			},
