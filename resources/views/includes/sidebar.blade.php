					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu {{request()->is('sopa/admin/eventsection/*') || request()->is('sopa/admin/eventsection') ? 'nav-item-expanded nav-item-open' : ''}}">
							...
							<ul class="nav-group-sub collapse">
								...
								<li class="nav-item"><a href="{{url('/sopa/admin/eventsection/edit/about')}}" class="nav-link  {{request()->is('sopa/admin/sponsors/category') ? 'active' : ''}}">About</a></li>
								<li class="nav-item"><a href="{{url('/sopa/admin/eventsection/edit/whoshouldattend')}}" class="nav-link  {{request()->is('sopa/admin/sponsors') ? 'active' : ''}}">Who Should Attend</a></li>
