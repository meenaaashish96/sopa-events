										    ...
										    <style> 
                                        	  .form-card {
									           ...
									           <table>
									               <tr>
									                   <td>Reff. No.<strong><i
																					class=""># </i>{{$request['image']?$request['image']:$request['delegate_reg_id']}}</strong></td>
									                   <td style="text-align:center;">Batch. No.<strong><i
									           ...
									           <table>
									               <tr>
									                   ...
									                   <td><b>{{$request->deletegateRegistation->deletegate_category}}</b></td>
									               </tr>
									                <tr>
									                   <td>Name</td>
									                ...
									                <tr>
									                   <td>Company Name</td>
									                   <td><b>{{$request->deletegateRegistation->organization_name}}</b></td>
									               </tr>
									                <tr>
									                   <td>GST No.</td>
									                   <td><b>{{$request->deletegateRegistation->GSTIN}}</b></td>
									               </tr> <tr>
									                   <td>Amount</td>
									                   <td><b>{{$request['total_delegate']}}/-</b></td>
									               </tr>
									           </table>
										</div>
