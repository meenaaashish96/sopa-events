...
<head>
    ...
    <title>Dinner Stall - QR Code Scanner</title>
...
<body>
    <h1>Dinner Stall - QR Code Scanner</h1>
    ...
    <form id="dinner-scan-form" action="{{ route('stall.dinner.scan') }}" method="POST">
        @csrf
    ...
    <script>
        function onScanSuccess(qrMessage) {
            ...
            // Set the scanned delegate ID to the hidden form field
            document.getElementById('delegate_id').value = qrMessage;
