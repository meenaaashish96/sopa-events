...
<head>
    ...
    <titleinner Stall - QR Code Scanner</title>
...
<body>
    <h1>Breakfast Stall - QR Code Scanner</h1>
    ...
    <form id="breakfast-scan-form" action="{{ route('stall.breakfast.scan') }}" method="POST">
        @csrf
    ...
    <script>
        function onScanSuccess(qrMessage) {
            ...
            // Submit the form
            document.getElementById('breakfast-scan-form').submit();
